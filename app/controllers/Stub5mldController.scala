...
trait Stub5mldController extends StubBaseController {

  def getEstate(id: String): Action[AnyContent]

  def successResponses(id: String)(implicit req: Request[AnyContent]): Future[Result] =
    id match {
